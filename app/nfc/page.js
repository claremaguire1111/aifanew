...
export default function NFCPage() {
  ...
  return (
    <div className="awards-page">
      <Head>
        <title>NFC Lisbon | AIFA at NFC - Leo Crane Main Stage Event on June 3rd</title>
        <meta name="description" content="NFC Lisbon - Join AIFA at NFC Lisbon on June 3rd featuring Leo Crane on the main stage, plus the launch of AIFA Awards 2025 with a distinguished global jury including Diane Pernet, David Sheldrick, and leading industry pioneers." />
        <meta name="keywords" content="NFC Lisbon, AIFA Awards 2025, Leo Crane, Main Stage, World's #1 Film Awards, Global Film Awards, AI Film Academy, AI filmmaking, David Sheldrick, Diane Pernet, digital art awards, NFT film, AI artists, future of entertainment, film innovation" />
        <meta property="og:title" content="NFC Lisbon | AIFA at NFC - Leo Crane Main Stage Event on June 3rd" />
        <meta property="og:description" content="Join us at NFC Lisbon on June 3rd featuring Leo Crane on the main stage, plus the launch of AIFA Awards 2025, the world's premier celebration of excellence in AI-generated filmmaking with an international jury of industry leaders." />
        <meta property="og:image" content="/images/jury2025/leo_crane.jpg" />
      ...
      <section className="awards-about" style={{ backgroundColor: 'var(--white)' }}>
        <div className="about-container">
          <h2 className="about-title">Leo Crane on the Main Stage</h2>
          <p className="about-description">Join us for a special presentation on AI filmmaking</p>
          
          <div className="event-highlight fade-in" style={{ 
            display: 'flex', 
      ...
      <section className="awards-about">
        <div className="about-container">
          <h2 className="about-title">AIFA Awards 2025</h2>
